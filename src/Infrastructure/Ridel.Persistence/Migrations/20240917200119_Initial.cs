        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "text", nullable: false),
                    SubscriptionFee = table.Column<decimal>(type: "numeric", nullable: false),
                    OrderCommission = table.Column<decimal>(type: "numeric", nullable: false),
                    ProfilePhotoUrl = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverId1 = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    TcpNumber = table.Column<string>(type: "text", nullable: false),
                    HasAirportPermit = table.Column<bool>(type: "boolean", nullable: false),
                    PassengerCapacity = table.Column<int>(type: "integer", nullable: false),
                    HasChildSeat = table.Column<bool>(type: "boolean", nullable: false),
                    ChildSeatCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offers_AspNetUsers_AcceptedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleVehicleFeature_VehicleFeatures_FeaturesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_AcceptedByUserId",
                table: "Offers",
